...
#     rays_o, rays_d, times_lidar = _get_lidar_rays(sequence_id, opt, device=device)
#     print(rays_o.shape)
#     # Keep the first rays_o for all scans to make the vehicle stationary
#     repeated_tensor = rays_o[0].unsqueeze(0).repeat(51, 1, 1)
#     rays_d_1 = rays_d[0].unsqueeze(0).repeat(51, 1, 1)
#     # Save results
#     sim.render(repeated_tensor, rays_d_1, times_lidar)
